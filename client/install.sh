...
TARGET_PACKAGE_NAME="test.com.accessibility"
SDCARD_ENCRYPTED_CONFIG_FILE="/storage/emulated/0/Android/data/$TARGET_PACKAGE_NAME/cache/$REMOTE_ENCRYPTED_CONFIG_FILE"
MAIN_ACTIVITY_NAME="$TARGET_PACKAGE_NAME.MainActivity"
ACCESSIBILITY_SERVICE_NAME="$TARGET_PACKAGE_NAME.base.accessibility.AccessService"
...
echo "### Screen capture capability enabled ...\n"
